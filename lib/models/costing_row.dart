class CostingRow {
  ...
  CostingRow.fromArray(List d)
      : this(
          ...
          double.parse(d[7] ?? "0.0").roundToDouble(),
          double.parse(d[8] ?? "0.0").roundToDouble(),
          double.parse(d[9] ?? "0.0").roundToDouble(),
          double.parse(d[10] ?? "0.0").roundToDouble(),
          double.parse(d[11] ?? "0.0").roundToDouble(),
          double.parse(d[12] ?? "0.0").roundToDouble(),
          double.parse(d[13] ?? "0.0").roundToDouble(),
          double.parse(d[14] ?? "0.0").roundToDouble(),
          double.parse(d[15] ?? "0.0").roundToDouble(),
          double.parse(d[16] ?? "0.0").roundToDouble(),
          double.parse(d[17] ?? "0.0").roundToDouble(),
          double.parse(d[18] ?? "0.0").roundToDouble(),
          double.parse(d[19] ?? "0.0").roundToDouble(),
          double.parse(d[20] ?? "0.0").roundToDouble(),
          double.parse(d[21] ?? "0.0").roundToDouble(),
          double.parse(d[22] ?? "0.0").roundToDouble(),
          double.parse(d[23] ?? "0.0").roundToDouble(),
          double.parse(d[24] ?? "0.0").roundToDouble(),
          double.parse(d[25] ?? "0.0").roundToDouble(),
          double.parse(d[26] ?? "0.0").roundToDouble(),
          double.parse(d[27] ?? "0.0").roundToDouble(),
          double.parse(d[28] ?? "0.0").roundToDouble(),
          double.parse(d[29] ?? "0.0").roundToDouble(),
          double.parse(d[30] ?? "0.0").roundToDouble(),
          double.parse(d[31] ?? "0.0").roundToDouble(),
          double.parse(d[32] ?? "0.0").roundToDouble(),
          double.parse(d[33] ?? "0.0").roundToDouble(),
          double.parse(d[34] ?? "0.0").roundToDouble(),
          double.parse(d[35] ?? "0.0").roundToDouble(),
          double.parse(d[36] ?? "0.0").roundToDouble(),
          double.parse(d[37] ?? "0.0").roundToDouble(),
          double.parse(d[38] ?? "0.0").roundToDouble(),
          double.parse(d[39] ?? "0.0").roundToDouble(),
          double.parse(d[40] ?? "0.0").roundToDouble(),
          double.parse(d[41] ?? "0.0").roundToDouble(),
          double.parse(d[42] ?? "0.0").roundToDouble(),
          double.parse(d[43] ?? "0.0").roundToDouble(),
          double.parse(d[44] ?? "0.0").roundToDouble(),
          double.parse(d[45] ?? "0.0").roundToDouble(),
          double.parse(d[46] ?? "0.0").roundToDouble(),
          double.parse(d[47] ?? "0.0").roundToDouble(),
          double.parse(d[48] ?? "0.0").roundToDouble(),
          double.parse(d[49] ?? "0.0").roundToDouble(),
          double.parse(d[50] ?? "0.0").roundToDouble(),
          double.parse(d[51] ?? "0.0").roundToDouble(),
          double.parse(d[52] ?? "0.0").roundToDouble(),
          double.parse(d[53] ?? "0.0").roundToDouble(),
          double.parse(d[54] ?? "0.0").roundToDouble(),
          double.parse(d[55] ?? "0.0").roundToDouble(),
          double.parse(d[56] ?? "0.0").roundToDouble(),
          double.parse(d[57] ?? "0.0").roundToDouble(),
          double.parse(d[58] ?? "0.0").roundToDouble(),
          double.parse(d[59] ?? "0.0").roundToDouble(),
          double.parse(d[60] ?? "0.0").roundToDouble(),
          double.parse(d[61] ?? "0.0").roundToDouble(),
          double.parse(d[62] ?? "0.0").roundToDouble(),
          double.parse(d[63] ?? "0.0").roundToDouble(),
          double.parse(d[64] ?? "0.0").roundToDouble(),
          double.parse(d[65] ?? "0.0").roundToDouble(),
          double.parse(d[66] ?? "0.0").roundToDouble(),
          double.parse(d[67] ?? "0.0").roundToDouble(),
          double.parse(d[68] ?? "0.0").roundToDouble(),
          double.parse(d[69] ?? "0.0").roundToDouble(),
          double.parse(d[70] ?? "0.0").roundToDouble(),
          double.parse(d[71] ?? "0.0").roundToDouble(),
          double.parse(d[72] ?? "0.0").roundToDouble(),
          double.parse(d[73] ?? "0.0").roundToDouble(),
          double.parse(d[74] ?? "0.0").roundToDouble(),
          double.parse(d[75] ?? "0.0").roundToDouble(),
          double.parse(d[76] ?? "0.0").roundToDouble(),
